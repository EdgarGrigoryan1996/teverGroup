        ...
        <div className={s.logo}>TEVER GROUP</div>
            <div className={s.menu}>
                ...
                <div className={s.burgerMenu + " " + (burgerMenuStatus && s.menuOpened)} onClick={() => setBurgerMenuStatus(!burgerMenuStatus) }><IoIosArrowForward /></div>
                    ...
                    <div className={s.item}><span><IoIosArrowForward />{t("menu.company.text")}</span>
                    ...
                    <div className={s.item}><span><IoIosArrowForward />{t("menu.services.text")}</span>
                    <div className={s.subMenu}>
                    ...
                    <div className={s.item}><span><IoIosArrowForward />{t("menu.resources.text")}</span>
                    <div className={s.subMenu}>
